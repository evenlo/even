    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">EvenLo</a>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Wait,what is Even.pw ?</h3>
                </div>
            </div>
            <div class="row text-center">
                <div class="col-md-4">
                    ...
                    <h4 class="service-heading">Actually</h4>
                    <p class="text-muted">事實上，這是個人網站</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <p class="text-muted">寫這網站，不外乎是下班、放假或者深夜時太無聊</p>
                    <p class="text-muted">才會敲著鍵盤Coding.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <h4 class="service-heading">Magic</h4>
                    <p class="text-muted">在這裡，我是法師，將創造一切</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Who am I ?</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
        ...
        <section id="blog" class="bg-light-gray">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="blog-member">
                            <img src="img/blog/2.jpg" class="img-responsive img-circle" alt="">
                            <h4>Larry Parker</h4>
                    ...
                    <div class="col-sm-4">
                        <div class="blog-member">
                            <img src="img/blog/3.jpg" class="img-responsive img-circle" alt="">
